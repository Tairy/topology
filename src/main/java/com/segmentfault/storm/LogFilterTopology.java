...
import com.segmentfault.storm.blot.KeyWordFilterBolt;
...
public class LogFilterTopology
{
    ...
    {
        String sourceFileName = "/Users/tairy/Documents/Working/log/test-data.txt";
        TopologyBuilder builder = new TopologyBuilder();
        builder.setSpout("sf-log", new LineSpout(),  1);
//        builder.setBolt("print", new PrinterBolt()).shuffleGrouping("sf-log");
        builder.setBolt("key-word", new KeyWordFilterBolt()).shuffleGrouping("sf-log");
